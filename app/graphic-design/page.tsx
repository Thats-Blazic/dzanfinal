        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              Focusing on YouTube channels across various niches, I provide art direction guidelines and creative concepts for thumbnails that will highlight the brand and capture audience attention.
            </p>
            <motion.div 
